...
Use `--progress` to display short progress sentences actually generated by the model
before its tool calls. The runtime does not synthesize these messages; models that
return empty content will produce no progress line.
